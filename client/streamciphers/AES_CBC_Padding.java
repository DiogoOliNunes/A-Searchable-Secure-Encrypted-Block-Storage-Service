...
public class AES_CBC_Padding {
    ...
    private static final byte[] CIPHER_KEY_BYTES = new byte[]{
    ...
    //como diz no enunciado The client splits the file into blocks, encrypts each block, generates a MAC or digital signature for integrity and authenticity, and sends the blocks to the server along with metadata keywords, e.g., finance, Q3
    ...
    private static final SecretKeySpec CIPHER_KEY = new SecretKeySpec(CIPHER_KEY_BYTES, "AES");
    ...
    public static byte[] encrypt(byte[] data) throws Exception {
        ...
        cipher.init(Cipher.ENCRYPT_MODE, CIPHER_KEY, ivSpec);
    ...
    public static byte[] decrypt(byte[] encryptedData) throws Exception {
        ...
        Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
        IvParameterSpec ivSpec = new IvParameterSpec(iv);
        cipher.init(Cipher.DECRYPT_MODE, CIPHER_KEY, ivSpec);
